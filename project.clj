(defproject web-enigma "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "web-enigma.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main web-enigma.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "web-enigma.core/on-figwheel-reload"}

                :compiler {:main web-enigma.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/web_enigma.js"
